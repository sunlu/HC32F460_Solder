/**
 * @file    pid.h
 * @brief   PID Controller header (ported from AxxSolder)
 *
 * Based on Brett Beauregard's Arduino PID library v1.2.1.
 * Features: anti-windup, asymmetric I-gain, measurement derivative,
 *           conditional integration, output clamping.
 */
#ifndef SOURCE_PID_H
#define SOURCE_PID_H
